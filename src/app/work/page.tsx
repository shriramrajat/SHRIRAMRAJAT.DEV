    ...
    <main className="min-h-screen relative bg-[#0c0c0f] selection:bg-accent selection:text-black overflow-hidden font-sans">
      ...
      <div className="w-full max-w-5xl mx-auto px-6 py-16 sm:py-24 relative z-10 flex flex-col gap-12">
        ...
        >
          ...
          {/* Project 4: SentinelRate */}
          <motion.article 
            variants={{
              hidden: { opacity: 0, x: -20 },
              visible: { opacity: 1, x: 0 }
            }}
            className="group relative border border-white/10 bg-black/40 backdrop-blur-sm rounded-xl overflow-hidden hover:border-indigo-500/30 transition-colors duration-500"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 sm:p-10 relative z-10">
              <div className="md:col-span-2 flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  <h2 className="text-3xl font-mono text-white group-hover:text-indigo-400 transition-colors">SentinelRate</h2>
                  <span className="font-mono text-[10px] text-indigo-400 border border-indigo-500/30 px-2 py-0.5 rounded-full bg-indigo-500/10">Rate Limiter Middleware</span>
                </div>
                <p className="text-slate-400 font-sans text-base leading-relaxed">
                  A high-performance L7 rate limiting middleware built directly into the FastAPI pipeline. Employs a Token Bucket mathematical engine with automatic lazy memory sweeps and dual-resolution IP/JWT tracking policies.
                </p>
                <Link href="/work/sentinelrate" className="font-mono text-sm text-indigo-400 mt-4 flex items-center gap-2 opacity-80 group-hover:opacity-100 group-hover:translate-x-2 transition-all">
                  Read Case Study &rarr;
                </Link>
              </div>
              <div className="md:col-span-1 border-l border-white/10 pl-6 hidden md:flex flex-col gap-4 justify-center">
                <div className="flex flex-col">
                  <span className="text-xs text-slate-500 font-mono uppercase">Tech Stack</span>
                  <span className="text-sm text-white font-mono mt-1">Python, FastAPI, Pytest</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-xs text-slate-500 font-mono uppercase">Focus</span>
                  <span className="text-sm text-white font-mono mt-1">L7 Middleware, Token Bucket, GC Sweeper</span>
                </div>
              </div>
            </div>
          </motion.article>

          {/* Project 5: API Monitor System */}
          <motion.article 
            variants={{
              hidden: { opacity: 0, x: -20 },
              visible: { opacity: 1, x: 0 }
            }}
            className="group relative border border-white/10 bg-black/40 backdrop-blur-sm rounded-xl overflow-hidden hover:border-amber-500/30 transition-colors duration-500"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 sm:p-10 relative z-10">
              <div className="md:col-span-2 flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  <h2 className="text-3xl font-mono text-white group-hover:text-amber-400 transition-colors">API Monitor System</h2>
                  <span className="font-mono text-[10px] text-amber-400 border border-amber-500/30 px-2 py-0.5 rounded-full bg-amber-500/10">Observability Platform</span>
                </div>
                <p className="text-slate-400 font-sans text-base leading-relaxed">
                  A decoupled observability architecture capturing request latency and error distributions asynchronously. Features pre-calculated analytical aggregates, custom telemetry dashboards, and incident summarizations.
                </p>
                <Link href="/work/apimonitor" className="font-mono text-sm text-amber-400 mt-4 flex items-center gap-2 opacity-80 group-hover:opacity-100 group-hover:translate-x-2 transition-all">
                  Read Case Study &rarr;
                </Link>
              </div>
              <div className="md:col-span-1 border-l border-white/10 pl-6 hidden md:flex flex-col gap-4 justify-center">
                <div className="flex flex-col">
                  <span className="text-xs text-slate-500 font-mono uppercase">Tech Stack</span>
                  <span className="text-sm text-white font-mono mt-1">Python, FastAPI, PostgreSQL, Chart.js</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-xs text-slate-500 font-mono uppercase">Focus</span>
                  <span className="text-sm text-white font-mono mt-1">Async Event Loops, Cron Rollups, LLM Auditing</span>
                </div>
              </div>
            </div>
          </motion.article>
          ...
          <motion.article 
            ...
            className="group relative border border-white/10 bg-black/40 backdrop-blur-sm rounded-xl overflow-hidden hover:border-emerald-500/30 transition-colors duration-500"
          >
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/0 via-emerald-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 sm:p-10 relative z-10">
              <div className="md:col-span-2 flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  <h2 className="text-3xl font-mono text-white group-hover:text-emerald-400 transition-colors">AI Resume Analyzer</h2>
                  <span className="font-mono text-[10px] text-emerald-400 border border-emerald-500/30 px-2 py-0.5 rounded-full bg-emerald-500/10">Recruitment Parser</span>
                </div>
                <p className="text-slate-400 font-sans text-base leading-relaxed">
                  A recruitment analysis platform featuring strict pipeline separation. It implements deterministic heuristic PDF parsing and ontology skill mapping while limiting LLM involvement to post-evaluation explanations.
                </p>
                <Link href="/work/resumeanalyzer" className="font-mono text-sm text-emerald-400 mt-4 flex items-center gap-2 opacity-80 group-hover:opacity-100 group-hover:translate-x-2 transition-all">
                  Read Case Study &rarr;
                </Link>
              </div>
              <div className="md:col-span-1 border-l border-white/10 pl-6 hidden md:flex flex-col gap-4 justify-center">
                <div className="flex flex-col">
                  <span className="text-xs text-slate-500 font-mono uppercase">Tech Stack</span>
                  <span className="text-sm text-white font-mono mt-1">Python, React, TypeScript, PostgreSQL</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-xs text-slate-500 font-mono uppercase">Focus</span>
                  <span className="text-sm text-white font-mono mt-1">Heuristic Extraction, Ontology Matching, Explanations</span>
                </div>
              </div>
            </div>
          </motion.article>
